...
describe('RMRKTokenAttributesRepository', async () => {
  ...
  describe('Registering attributes and setting values', async () => {
    beforeEach(async () => {
    ...
    it('can set and get token attributes', async () => {
      expect(
    ...
    it('can set multiple attributes of multiple types at the same time', async () => {
      await expect(
    ...
    it('can update multiple attributes of multiple types at the same time', async () => {
    ...
    it('can set and update multiple attributes of multiple types at the same time even if not all types are updated at the same time', async () => {
      await tokenAttributes.setAttributes(
        await ownedCollection.getAddress(),
        tokenId,
        [{ key: 'string1', value: 'value0' }],
    ...
    it('can set and update multiple attributes of multiple types at the same time', async () => {
      await expect(
        tokenAttributes.setAttributes(
          await ownedCollection.getAddress(),
          tokenId,
    ...
    it('should allow to retrieve multiple attributes at once', async () => {
      await tokenAttributes.setAttributes(
        await ownedCollection.getAddress(),
        tokenId,
        [
    ...
    it('can set multiple string attributes at the same time', async () => {
      await expect(
    ...
    it('can set multiple uint attributes at the same time', async () => {
      await expect(
    ...
    it('can set multiple bool attributes at the same time', async () => {
      await expect(
    ...
    it('can set multiple address attributes at the same time', async () => {
      await expect(
    ...
    it('can set multiple bytes attributes at the same time', async () => {
      await expect(
    ...
    it('can reuse keys and values are fine', async () => {
      await tokenAttributes.setStringAttribute(
        await ownedCollection.getAddress(),
        tokenId,
        'X',
    ...
    it('can reuse keys among different attributes and values are fine', async () => {
      await tokenAttributes.setStringAttribute(
        await ownedCollection.getAddress(),
        tokenId,
        'X',
    ...
    it('can reuse string values and values are fine', async () => {
      await tokenAttributes.setStringAttribute(
        await ownedCollection.getAddress(),
        tokenId,
        'X',
    ...
    it('should not allow to set string values to unauthorized caller', async () => {
      await expect(
        tokenAttributes
          .connect(tokenOwner)
          .setStringAttribute(
    ...
    it('should not allow to set uint values to unauthorized caller', async () => {
      await expect(
        tokenAttributes
          .connect(tokenOwner)
          .setUintAttribute(
    ...
    it('should not allow to set boolean values to unauthorized caller', async () => {
      await expect(
        tokenAttributes
          .connect(tokenOwner)
          .setBoolAttribute(
    ...
    it('should not allow to set address values to unauthorized caller', async () => {
      await expect(
        tokenAttributes
          .connect(tokenOwner)
          .setAddressAttribute(
    ...
    it('should not allow to set bytes values to unauthorized caller', async () => {
      await expect(
        tokenAttributes
          .connect(tokenOwner)
          .setBytesAttribute(
  ...
  describe('Token attributes access control', async () => {
    it('should not allow registering an already registered collection', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should not allow to register a collection if caller is not the owner of the collection', async () => {
      await expect(
        tokenAttributes
          .connect(tokenOwner)
    ...
    it('should not allow to register a collection without Ownable implemented', async () => {
    ...
    it('should allow to manage access control for registered collections', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should allow issuer to manage collaborators', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should not allow to manage collaborators of an unregistered collection', async () => {
      await expect(
        tokenAttributes
          .connect(collectionOwner)
          .manageCollaborators(
    ...
    it('should not allow to manage collaborators if the caller is not the issuer', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should not allow to manage collaborators for registered collections if collaborator arrays are not of equal length', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should not allow to manage access control for unregistered collections', async () => {
      await expect(
        tokenAttributes
          .connect(collectionOwner)
          .manageAccessControl(
    ...
    it('should not allow to manage access control if the caller is not issuer', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should not allow to manage access control if the caller is not returned as collection owner when using ownable', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        true,
    ...
    it('should return the expected value when checking for collaborators', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should return the expected value when checking for specific addresses', async () => {
      await tokenAttributes.registerAccessControl(
        await ownedCollection.getAddress(),
        await collectionOwner.getAddress(),
        false,
    ...
    it('should use the issuer returned from the collection when using only issuer when only issuer is allowed to manage parameter', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should only allow collaborator to modify the parameters if only collaborator is allowed to modify them', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should only allow issuer and collaborator to modify the parameters if only issuer and collaborator is allowed to modify them', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should only allow issuer and collaborator to modify the parameters if only issuer and collaborator is allowed to modify them even when using the ownable', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should only allow token owner to modify the parameters if only token owner is allowed to modify them', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should only allow specific address to modify the parameters if only specific address is allowed to modify them', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should allow to use presigned message to modify the parameters', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should not allow to use presigned message to modify the parameters if the deadline has elapsed', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should not allow to use presigned message to modify the parameters if the setter does not match the actual signer', async () => {
      await tokenAttributes
        .connect(collectionOwner)
        .registerAccessControl(
          await ownedCollection.getAddress(),
    ...
    it('should not allow to use presigned message to modify the parameters if the signer is not authorized to modify them', async () => {
      const uintMessage =
        await tokenAttributes.prepareMessageToPresignUintAttribute(
          await ownedCollection.getAddress(),
          tokenId,
