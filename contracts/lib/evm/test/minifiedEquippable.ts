...
async function parentChildFixture(): Promise<{
  ...
  return {
    parent: <RMRKMinifiedEquippableMock>parent,
    child: <RMRKMinifiedEquippableMock>child,
  };
}
...
describe('MinifiedEquippableMock ERC721 behavior', () => {
  beforeEach(async function () {
...
describe('MinifiedEquippableMock Nestable Behavior', () => {
  beforeEach(async function () {
